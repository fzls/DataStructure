...
//struct Vertex {
//    char name[4];
//    FlowEdge *flow_edges;           // Á÷ÍøÂç
//    ResidualEdge *residual_edges;   // ²ÐÁôÍø
//    int dirty_flag;
//    int bfs_color;
...
//        ResidualEdge *forward_residual_edge = new ResidualEdge( src_vex, dst_vex, flow_edge, capacity, false ); // ÕýÏò»¡
//        forward_residual_edge->next = src_vex->residual_edges;
//        src_vex->residual_edges = forward_residual_edge;
//        ResidualEdge *reverse_residual_edge = new ResidualEdge( dst_vex, src_vex, flow_edge, 0, true );      // ·´Ïò»¡
...
//                ( *iter )->corresponding_edge->residual += min_residual; // ÕýÏò²ÐÓà»¡
//            } else {
//                ( *iter )->flow_edge->flow += min_residual;
//                ( *iter )->corresponding_edge->residual -= min_residual; // ·´Ïò²ÐÓà»¡
//            }
//        }
//        ++i;
//    }
